...
export function NotePreview({ note, onRemoveNote, onAddNote }) {

    const [backgroundColor, setBackgroundColor] = useState(note.style.backgroundColor)
    ...
    return (
        <section style={{ backgroundColor: backgroundColor }} className="note-preview">
            ...
            <NoteActionBtns currColor={backgroundColor} onSelect={onColorSelect} options={options} />
