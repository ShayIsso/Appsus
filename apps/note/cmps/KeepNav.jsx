...
export function KeepNav({ filter, onSetFilter }) {
    ...
    return (
        <nav className="keep-nav flex column ">
            ...
            <NavLink className="Notes" to="/note" onClick={() => onSetFilter({ side: '' })}>
            ...
            <NavLink className="Archive" to="/archived" onClick={() => onSetFilter({ side: 'archived' })}>
            ...
            <NavLink className="Trash" to="/trash" onClick={() => onSetFilter({ side: 'deleted' })}>
